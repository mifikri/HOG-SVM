...
static string posSamplesDir = "/home/fikri/trainHOG2/pos/";
// Directory containing negative sample images
static string negSamplesDir = "/home/fikri/trainHOG2/neg12/";
// Set the file to write the features to
static string featuresFile = "/home/fikri/trainHOG2/genfiles/features.dat";
// Set the file to write the SVM model to
static string svmModelFile = "/home/fikri/trainHOG2/genfiles/svmlightmodel.dat";
// Set the file to write the resulting detecting descriptor vector to
static string descriptorVectorFile = "/home/fikri/trainHOG2/genfiles/descriptorvector.dat";
...
int main(int argc, char** argv) {
    ...
    hog.winSize = Size(60, 24); // Default training images size as used in paper
    hog.blockSize = Size(10, 4);
    hog.blockStride = Size(5, 2);
    hog.cellSize = Size(5, 2);
